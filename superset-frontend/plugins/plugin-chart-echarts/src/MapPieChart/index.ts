...
import example from './images/MapPie.jpg';
import thumbnail from './images/thumbnail.png';
import { MapPieQueryFormData, EchartsMapPieChartProps } from './types';

export default class EchartsMapPieChartPlugin extends ChartPlugin<
  MapPieQueryFormData,
  EchartsMapPieChartProps
> {
  /**
  ...
  constructor() {
    super({
      buildQuery,
      controlPanel,
      loadChart: () => import('./EchartsMapPie'),
